...
const EventsBooking = require('./Models/eventsbooking.model');

async function ValidateEventOrder(req, res) {
  ...
  try {
    ...
    const updatedOrder = await EventsBooking.findOneAndUpdate(
...
module.exports = { ValidateEventOrder };
